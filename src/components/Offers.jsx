...
const currentOffers =[
    {
        ...
        description: "Enjoy our exclusive summer sale with discounts up to 30% on selected perfumes. Limited time offer!",
        discount: '30%',
        endDate: "2026-08-31",
        code: "SUMMER30",
    ...
    textColor:"text-amber-700", 
   },
      {
        ...
        description: "For a limited time, receive a complimentary perfume sample with every purchase. Discover your new favorite scent today!",
        discount: 'Gift',
        endDate: "2026-08-31",
        code: "FREESAMPLE",
   ...
   },  
    {
        ...
        discount: '20%',
        description: "Celebrate the launch of our new fragrance line with a special 20% discount on all new arrivals. Use code NEW20 at checkout!",
        endDate: "2024-08-31",
        code: "NEW20",
        bgColor:"bg-pink-200",
...
const Offers = () => {
  ...
  <section id='offers' className='container scroll-mt-20 mx-auto px-4 py-12'>
     ...
     <p className='text-center text-gray-600 mb-12'>
        Take advantage of these limited-time offers and elevate your fragrance collection today!
     </p>
            ...
            currentOffers.map((offers) =>(
                ...
                >
                    <div className='p-6'>
                        ...
                        <button className={`w-full py-3 rounded-lg ${offers.textColor} font-semibold
                        border ${offers.textColor.replace('text', 'border')} hover:bg-white`}>
                            claim Offer
