...
const Hero = () => {
  return (
    <section id="home" className="bg-amber-50 scroll-mt-20 py-16">
      <div
        className="max-w-7xl mx-auto px-4 lg:px-8 flex
        flex-col-reverse lg:flex-row items-center gap-10"
      >
        <div className="text-center lg:text-left max-w-xl">
          <h1
            className="text-4xl sm:text-5xl font-bold text-amber-950
        leading-tight mb-4 "
          >
            Discover The Best Deals on Top Products
          </h1>
          <p className="text-gray-700 text-base sm:text-lg mb-6">
            Explore our exquisite collection of perfumes and discover
            captivating scents that leave a lasting impression. From timeless
            classics to the latest fragrances, find your signature aroma at
            unbeatable prices.
          </p>
