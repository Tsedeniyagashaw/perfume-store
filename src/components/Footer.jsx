...
<div>
    ...
    <form action="" className="flex">
        ...
        className='px-4 py-2 w-full rounded-1 focus:outline-none text-gray-200'  required/>
  
    <button type='submit' className='bg-pink-700 hover:bg-pink-800 text-white px-4 py-2
