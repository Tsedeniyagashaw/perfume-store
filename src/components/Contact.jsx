       ...
       <h2 className='text-2xl font-serif font-semibold text-gray-900 mb-6'>Send Us a Message</h2>
           <form className='space-y-6' action="">
              <div>
                ...
                <input type="text" className='w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2
                focus:ring-gray-500 focus:border-transparent' placeholder='Your name' />
                </div> 
                <div>
                <label className='block text-sm font-medium text-gray-800 mb-1'>Your Email</label>
                <input type="text" className='w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2
                focus:ring-gray-500 focus:border-transparent' placeholder='Your@email.com' />
                </div> 
                <div>
                ...
                focus:ring-gray-500 focus:border-transparent' placeholder='Your Message' />
                </div> 
                <button className='w-ful bg-pink-700 hover:bg-pink-600 text-white py-3 px-6 rounded-lg
...
<div>
    ...
    <p className='text-gray-800'>+251 967 4854922</p>
...
<div className='flex items-start'>
    ...
    <p className='text-gray-800'>22, golagul</p>
